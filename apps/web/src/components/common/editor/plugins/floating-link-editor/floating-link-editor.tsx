...
const FloatingLinkEditor = ({
  ...
  return (
    <div ref={editorRef} className={clsx("css-var-rt", "ant-menu-css-var", styles["wrapper"])}>
      {!isLink ? null : isLinkEditMode ? (
        <Space align="start" className={clsx(styles["editor"], "ant-btn", "css-var-rt")}>
          <Input
            value={editedLinkUrl}
        ...
        <Space align="center" className={clsx(styles["editor"], "ant-btn", "css-var-rt")}>
          <Typography.Link
